			...
			<div class="col-sm-12">	
				...
				<div class="row">
					<div class="col-md-6" style="width:50%; float:left;">
						...
						<p style="font-size:13px">  <b>Valor (Mão de Obra): </b> R$ <?php echo number_format($total_ser, 2, ',', '.') ?> </p>
						<p style="font-size:13px">  <b>Valor Peças / Produtos: </b> R$ <?php echo $total_prod_f; ?> </p><?php } ?>
						<p style="font-size:13px">  <b>Valor Extra: </b> R$ <?php echo $valor_orc_f; ?> </p> 
						<p style="font-size:13px">  <b>Mecânico: </b> <?php echo $obs; ?>  </p> 
					...
					<div class="col-md-4 areaTotal" align="right"  style="width:40%; float:right;">	
						...
						<p class="pgto" style="font-size:12px">  <strong>GARANTIA:</strong><?php echo$garantia?><br> 
							 </p>
							<?php }else{ ?>
