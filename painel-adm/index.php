...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta name="author" content="Codigo Quatro">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <li class="nav-item">
                    <a target="_blank" class="nav-link" href="../painel-mecanico">
                        <i class="fas fa-coins fa-chart-area"></i>
                        <span class="">Painel Mecânico</span></a>
            </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <img class="" src="../img/scar1.png" width="60">
