...
$res2 = $pdo->prepare("INSERT INTO contas_pagar SET descricao = 'Compra de Produtos', valor = :valor, funcionario = :funcionario, data = curDate(), data_venc = curDate(), pago = 'Não', fornecedor = '$fornecedor' ");

$res3 = $pdo->prepare("INSERT INTO compras SET produto = '$id', valor = :valor, funcionario = :funcionario, data = curDate(), id_conta = :id_conta, fornecedor = '$fornecedor', quantidade = $quantidade ");
